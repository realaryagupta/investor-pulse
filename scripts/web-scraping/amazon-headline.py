...
# Fetch only Amazon headlines
for symbol in amazon_tickers:
    ...
    while True:
        ...
        for article in articles:
            ...
            # Confirm article is about the correct Amazon ticker
...
df.to_csv('../../data/scraped-data/scraped-amazon-headlines.csv')