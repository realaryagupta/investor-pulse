...
# Fetch only Apple headlines
for symbol in apple_tickers:
    ...
    while True:
        ...
        for article in articles:
            ...
            # Confirm article is about the correct Apple ticker
...
df.to_csv('../../data/scraped-data/scraped-apple-headlines.csv')
