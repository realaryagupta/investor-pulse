...
# Fetch only Google headlines
for symbol in google_tickers:
    ...
    while True:
        ...
        for article in articles:
            ...
            # Confirm article is about the correct Google ticker
...
df.to_csv('../../data/scraped-data/scraped-google-headlines.csv')