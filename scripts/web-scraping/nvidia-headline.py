...
# Fetch only Nvidia headlines
for symbol in nvidia_tickers:
    ...
    while True:
        ...
        for article in articles:
            ...
            # Confirm article is about the correct Nvidia ticker
...
df.to_csv('../../data/scraped-data/scraped-nvidia-headlines.csv')